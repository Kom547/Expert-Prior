...
# env in TrafficEnv3-v5 TrafficEnv8-v1; do
env=TrafficEnv3-v5
...
algo=PPO
      ...
      for eps in $(seq 0.05 0.01 0.1); do
        ...
        cuda_number=0
        # 拼接完整的命令，根据原命令模板
        cmd="python evaluation.py --algo ${algo} --env_name ${env} --train_step 100 --attack_eps ${eps} --random_seed --attack --best_model --addition_msg ${addition_msg}"
        # 分发到对应 GPU 的命令文件中
...
wait
echo "所有实验任务已完成."
#python train.py --algo PPO --env_name TrafficEnv3-v5 --train_step 300 --addition_msg vecPPO_2 --n_steps 2048 --n_epochs 5 --clip_range 0.1
#python evaluation.py --algo TD3 --env_name TrafficEnv3-v5 --train_step 100 --random_seed --best_model --addition_msg
