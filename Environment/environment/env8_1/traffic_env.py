...
config_path = os.path.dirname(__file__)+"/../../../Environment/environment/env8_1/On-Ramp_merging.sumocfg"  # Unprotected left turn in mixed traffic
...
class Traffic_Env(gym.Env):
    ...
    def __init__(self, attack=False, adv_steps=2, eval=False, defense=False, use_gui=False, render_mode=None, random_seed=False):
        self.state_dim = 26
        self.action_dim = 1
    ...
    def reset(self, seed=None, options=None):
        ...
        if self.eval:
            sumo_seed = (self.reset_times + 5 * 10000) % 1000000
